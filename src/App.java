...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Acknowledger.png"))); // NOI18N
    ...
    private void BtnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOKActionPerformed
        ...
        try {
            FileWriter writer = new FileWriter("DB.dat");
            writer.write(name);
            writer.close();
            ...
            JOptionPane.showMessageDialog(rootPane, "Error: The DB file is not created"+"\n"+e.getMessage(), "Error(0x2332)", 0);
        }
